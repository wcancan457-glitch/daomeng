...
MODEL_CONFIG: dict[str, Any] = {'models': {'deepseek-chat': {'name': 'DeepSeek Chat',
            ...
            'Qwen/Qwen2.5-72B-Instruct': {'name': 'Qwen2.5 72B Instruct (SiliconFlow)',
                                           'provider': 'siliconflow',
                                           'family': 'qwen',
                                           'type': ['llm'],
                                           'concurrency': 5,
                                           'capabilities': {'ability_type': 'text_generation',
            ...
            'deepseek-ai/DeepSeek-V3': {'name': 'DeepSeek V3 (SiliconFlow)',
                                        'provider': 'siliconflow',
                                        'family': 'deepseek',
                                        'type': ['llm'],
                                        'concurrency': 5,
                                        'capabilities': {'ability_type': 'text_generation',
                                                         ...
                                                         'adapter_input_modalities': ['text'],
                                                         'api_contract_verified': True}},
            'Qwen/Qwen3-235B-A22B-Instruct-2507': {'name': 'Qwen3 235B A22B Instruct (SiliconFlow)',
                                                        'provider': 'siliconflow',
                                                        'family': 'qwen',
                                                        'type': ['llm'],
                                                        'concurrency': 5,
                                                        'capabilities': {'ability_type': 'text_generation',
                                                                         ...
                                                                         'adapter_input_modalities': ['text'],
                                                                         'api_contract_verified': True}},
            'Qwen/Qwen3-30B-A3B-Instruct-2507': {'name': 'Qwen3 30B A3B Instruct (SiliconFlow)',
                                                  'provider': 'siliconflow',
                                                  'family': 'qwen',
                                                  'type': ['llm'],
                                                  'concurrency': 8,
                                                  'capabilities': {'ability_type': 'text_generation',
                                                                   ...
                                                                   'adapter_input_modalities': ['text'],
                                                                   'api_contract_verified': True}},
            'deepseek-ai/DeepSeek-V3.1': {'name': 'DeepSeek V3.1 (SiliconFlow)',
                                          'provider': 'siliconflow',
                                          'family': 'deepseek',
                                          'type': ['llm'],
                                          'concurrency': 5,
                                          'capabilities': {'ability_type': 'text_generation',
                                                           ...
                                                           'adapter_input_modalities': ['text'],
                                                           'api_contract_verified': True}},
            'Qwen/Qwen2.5-VL-72B-Instruct': {'name': 'Qwen2.5 VL 72B Instruct (SiliconFlow)',
                                             'provider': 'siliconflow',
                                             'family': 'qwen',
                                             'type': ['vlm'],
                                             'concurrency': 3,
