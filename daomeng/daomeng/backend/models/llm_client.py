...
class LLM:
    def __init__(self, gemini_base_url="", gemini_api_key="", gpt_base_url="", gpt_api_key="", deepseek_base_url="", deepseek_api_key="", dashscope_api_key="", siliconflow_base_url="", siliconflow_api_key=""):
        ...
        self._siliconflow_base_url = siliconflow_base_url or Config.SILICONFLOW_BASE_URL
        self._siliconflow_api_key = siliconflow_api_key or Config.SILICONFLOW_API_KEY
    ...
    def siliconflow_client(self):
        if self._siliconflow_client is None:
            self._siliconflow_client = GPT(
                base_url=self._siliconflow_base_url,
                api_key=self._siliconflow_api_key,
                proxy=Config.provider_proxy("siliconflow"),
            )
    ...
    def query(self, prompt, image_urls=[], model="qwen3.6-max-preview", safe_content=True, task_id=None, web_search=False):
        ...
        if provider == "siliconflow":
            result = self.siliconflow_client.query(prompt, image_urls=image_urls, model=model, web_search=False)
