...
class Config:
    ...
    SILICONFLOW_API_KEY = _get(CONFIG, "api_providers.siliconflow.api_key")
    SILICONFLOW_BASE_URL = _get(CONFIG, "api_providers.siliconflow.base_url")
    SILICONFLOW_ENABLE_PROXY = _get(CONFIG, "api_providers.siliconflow.enable_proxy")
    ...
    def update_config(cls, values: Dict[str, Any]) -> Dict[str, Any]:
        ...
        cls.SILICONFLOW_API_KEY = _get(clean, "api_providers.siliconflow.api_key")
        cls.SILICONFLOW_BASE_URL = _get(clean, "api_providers.siliconflow.base_url")
        cls.SILICONFLOW_ENABLE_PROXY = _get(clean, "api_providers.siliconflow.enable_proxy")
